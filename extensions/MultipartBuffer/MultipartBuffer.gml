...
#define __multipart_write_subarray__
...
#define __multipart_write_substruct__
...
///@param boundary
{
	...
	var keys = isConflict ? a2.keys() : variable_struct_get_names(argument2);
	var nKeys = array_length(keys);
	for (var i = 0; i < nKeys; ++i) {
		var k = keys[i];
		var v = isConflict ? a2.get(k) : variable_struct_get(argument2, k);
		var ck = argument0 + "[" + k + "]";
		switch (typeof(v)) {
			case "string":
				buffer_write(argument1, buffer_text, "\r\n");
